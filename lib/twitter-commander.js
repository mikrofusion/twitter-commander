...
require('./timeline/timeline-module')(viewManager, twitterCommander, ioInterface);
require('./goodbye/goodbye-module')(viewManager, twitterCommander, ioInterface);
require('./prompt/prompt-module')(viewManager, twitterCommander, ioInterface);
...
twitterCommander.run = function(creds) {
  ...
  //twitterCommander.setView('prompt');
};
